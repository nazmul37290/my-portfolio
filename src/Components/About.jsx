  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
      ...
      <div className="w-1/2 mt-10">
        <h2 className="font-bold text-white text-2xl">Personal Information</h2>
        <p className="text-gray-400 mt-5 w-2/3">
          ...
          enabling me to work on full-stack projects and understand server-side
          development.
        </p>
...
<SectionHeading heading={"About me"} title={"Web Developer"}></SectionHeading>;
